...
export ZSH="/home/darun/.oh-my-zsh"
...
export PATH="/home/darun/.local/bin:$PATH"

##Aliases I DONT want from OhMyZsh
unalias la
unalias l
unalias ll
...
alias cd..="cd .." #more often than not....
#Ubuntu specific
...
alias tree="tree -F --dirsfirst -L 3; echo 'modified command'"
...
alias recurseSize="ls -oRFSr"                       #omit group, recursively list, format, sort by size, reverse size sort

#for opening stuff
alias vsc="code"
neofetch #cuz why not..it looks pretty 

#Shell Profile palette (need to set by gui)
#21222C
#FF6E6E
#69FF94
#FFFFA5
...
#Always good to have quirks:
#Font: Hack Regular 10pt (From Google Fonts)
